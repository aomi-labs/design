...
Aomi's current language is bright, cool, editorial, and technically precise. Use white or cool-light space, near-black ink, restrained borders, and a few purposeful accents. Lilac, rosy pink, sky, and partner colors can provide contrast without turning the entire film into one hue.
