  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        // Sky accent CTA — the interactive accent with on-brand text.
        accent:
          "bg-[var(--aomi-accent-interactive)] text-[var(--aomi-text-on-brand)] hover:bg-[var(--aomi-accent-hover)] active:bg-[var(--aomi-accent-active)]",
        glass:
